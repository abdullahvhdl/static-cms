...
```bash
git remote add encore encore://static-cms-z9si
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/static-cms-z9si/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/static-cms-z9si/settings/integrations/github)
